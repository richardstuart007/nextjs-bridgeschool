...
import EditPopup from '@/app/admin/library/libraryedit/libraryEditPopup'
import AddPopup from '@/app/admin/library/libraryadd/libraryAddPopup'
  ...
  return (
    <>
      ...
      <div className='mt-2 md:mt-6 flow-root'>
        ...
        {/* Add Modal */}
        {isModelOpenAdd && <AddPopup isOpen={isModelOpenAdd} onClose={handleModalCloseAdd} />}
